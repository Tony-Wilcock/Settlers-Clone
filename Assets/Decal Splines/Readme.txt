Updating DecalSplines:
After importing an update for the Decal Spline package via the package manager, 
make sure you manually delete the URP/HDRP folder found in the main Decal Splines folder, 
and then reimport the URP/HDRP Asset as described in the setup section. 
